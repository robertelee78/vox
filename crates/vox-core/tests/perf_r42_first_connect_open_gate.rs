//! PRD-001 **R42, open** (both nodes on public addresses: rung 1, a direct dial) — a **first connection** to a peer, cold, including NAT traversal,
...
fn r42_a_first_connection_completes_in_under_two_seconds_open() {
    ...
    watchdog::arm();
    perf_r42::run(perf_r42::Topology::Open);
}
