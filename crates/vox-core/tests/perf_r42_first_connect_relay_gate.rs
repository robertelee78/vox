//! PRD-001 **R42, relay** (both behind symmetric NATs: rung 4, a circuit through the anchor) — a **first connection** to a peer, cold, including NAT traversal,
...
fn r42_a_first_connection_completes_in_under_two_seconds_relay() {
    ...
    watchdog::arm();
    perf_r42::run(perf_r42::Topology::Relay);
}
